...
import solutions.mundovirtual.api.APIFunctions;
import solutions.mundovirtual.api.JobsAPI;
import solutions.mundovirtual.cli.CLIArguments;
import solutions.mundovirtual.cli.CLIFunctions;
...
public class JobSearch {
    ...
    private static Stream<JobPosition> executeRequest(Map<String, Object> options) {
        JobsAPI api = APIFunctions.buildAPI(JobsAPI.class, "https://jobs.github.com");
